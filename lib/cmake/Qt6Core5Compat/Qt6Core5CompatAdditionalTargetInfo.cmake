...
get_target_property(_qt_imported_soname Qt6::Core5Compat IMPORTED_SONAME_RELWITHDEBINFO)
...
if(_qt_imported_soname)
    set_property(TARGET Qt6::Core5Compat PROPERTY IMPORTED_SONAME_RELEASE "${_qt_imported_soname}")
endif()
